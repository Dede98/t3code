...
const WsProviderSyncThreadContinuationRpc = Rpc.make(WS_METHODS.providerSyncThreadContinuation, {
...
const WsSubscribeProviderUsageRpc = Rpc.make(WS_METHODS.subscribeProviderUsage, {
  payload: Schema.Struct({}),
...
const WsRefreshProviderUsageRpc = Rpc.make(WS_METHODS.refreshProviderUsage, {
  payload: Schema.Struct({
