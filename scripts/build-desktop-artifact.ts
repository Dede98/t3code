...
export class LocalMacSigningConfigurationError extends Schema.TaggedError<LocalMacSigningConfigurationError>()(
...
export class LocalMacSigningHookResolutionError extends Schema.TaggedError<LocalMacSigningHookResolutionError>()(
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  const buildConfig: Record<string, unknown> = {
    ...
    files: [
      ...
      ...(localMacSigning ? [`!${LOCAL_MAC_SIGN_HOOK_FILE}`] : []),
    ],
    directories: {
