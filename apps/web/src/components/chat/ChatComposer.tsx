...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const activeThreadProviderDisplayName = useMemo(() => {
    ...
    return (
      entry?.displayName ??
      formatProviderDriverKindLabel(entry?.driverKind ?? usageProvider ?? selectedProvider)
    );
  }, [providerInstanceEntries, selectedProvider, usageProvider, usageProviderInstanceId]);
                ...
                >
                  {noProviderAvailable ? (
                    ...
                    <ProviderModelPicker
                      ...
                      {...(providerUsage.data
                        ? { providerUsageByInstance: providerUsage.data }
                        : {})}
