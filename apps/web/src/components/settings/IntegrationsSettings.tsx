...
import { MoreVertical, Plus as PlusIcon, Trash2Icon } from "lucide-react";
...
function ExternalMcpServersSettings() {
  ...
  return (
    <EnvironmentExternalMcpServersSettings
...
function EnvironmentExternalMcpServersSettings({
  environmentId,
}: {
  environmentId: EnvironmentId;
}) {
  const settings = useEnvironmentSettings(environmentId);
  const servers = settings.externalMcpServers;
