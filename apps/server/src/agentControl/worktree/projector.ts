  ...
  function* (
    ...
    if (event.type === "agentControl.worktree.ready") {
      ...
      return yield* validateAgentControlWorktreeReservationState({
        ...
        gitCreatedDevice: event.payload.gitCreatedDevice,
        gitCreatedInode: event.payload.gitCreatedInode,
        gitCreatedGitDir: event.payload.gitCreatedGitDir,
        markedOwnershipFingerprint: event.payload.markedOwnershipFingerprint,
        headCommitSha: event.payload.headCommitSha,
        ownershipFingerprint: event.payload.ownershipFingerprint,
    ...
    return yield* validateAgentControlWorktreeReservationState({
      ...
      materializationPhase: event.payload.materializationPhase,
      gitCreatedDevice: event.payload.gitCreatedDevice,
      gitCreatedInode: event.payload.gitCreatedInode,
      gitCreatedGitDir: event.payload.gitCreatedGitDir,
      markedOwnershipFingerprint: event.payload.markedOwnershipFingerprint,
