...
describe("UsageAggregator", () => {
  ...
  it("splits an hourly request into fixed buckets anchored to its exact start", () => {
    ...
    expect(result.buckets.map((bucket) => [bucket.sourceId, bucket.day, bucket.hourStart])).toEqual(
      [
        ["claude:1", "2026-08-06", "2026-08-07T02:37:00.000Z"],
        ["claude:1", "2026-08-06", "2026-08-07T03:37:00.000Z"],
      ],
    );
  });
