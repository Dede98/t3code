...
export class OrchestrationCommandAuthorityMismatchError extends Schema.TaggedError<OrchestrationCommandAuthorityMismatchError>()(
...
export class OrchestrationCommandIdentityConflictError extends Schema.TaggedError<OrchestrationCommandIdentityConflictError>()(
