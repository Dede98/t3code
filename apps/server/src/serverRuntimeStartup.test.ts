    ...
    Effect.gen(function* () {
      ...
      yield* ServerRuntimeStartup.launchStartupHeartbeat.pipe(
        Effect.provideService(ProjectionSnapshotQuery.ProjectionSnapshotQuery, {
          getThreadRuntimeContext: () => Effect.die("Unexpected query"),
          getTurnStartMessage: () => Effect.die("Unexpected query"),
          getUserInputActivity: () => Effect.die("Unexpected query"),
          searchThreads: () => Effect.die("Unexpected query"),
          getEventReplayStats: () => Effect.die("Unexpected query"),
          getImportedAgentSessionSources: () => Effect.die("Unexpected query"),
  ...
  () =>
    Effect.gen(function* () {
      ...
      const targets = yield* ServerRuntimeStartup.resolveAutoBootstrapWelcomeTargets.pipe(
        ...
        Effect.provideService(OrchestrationEngine.OrchestrationEngineService, {
          dispatchClient: () => Effect.die("Unexpected client dispatch"),
          dispatchAgentControl: () => Effect.die("Unexpected agent dispatch"),
          readEvents: () => Stream.empty,
          readThreadEvents: () => Stream.empty,
          getThreadReplayStats: () => Effect.die("unused thread replay stats"),
          dispatch: (command) =>
