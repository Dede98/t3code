...
export const SYNTHETIC_CLAUDE_MODEL_CATALOG: ClaudeModelCatalog = {
  models: [
    {
      model: {
        slug: "claude-synthetic-native-xhigh",
        name: "Claude Synthetic Native Effort",
        isCustom: false,
        capabilities: {
          optionDescriptors: [
            { ...effort, options: [...effort.options, { id: "xhigh", label: "Extra high" }] },
          ],
        },
      },
      runtime: {},
    ...
    {
      model: {
        slug: "claude-synthetic-normalized",
        name: "Claude Synthetic Normalized",
        isCustom: false,
        capabilities: {
          optionDescriptors: [
            {
              ...effort,
              options: [
                ...effort.options.map((option) => ({ ...option, isDefault: false })),
      ...
      runtime: { effortMap: { xhigh: "max" } },
      compatibility: {},
    },
    {
      model: {
        slug: "claude-synthetic-restricted",
        name: "Claude Synthetic Restricted",
        isCustom: false,
        capabilities: {
          optionDescriptors: [
            { ...effort, options: effort.options.filter((option) => option.id !== "max") },
          ],
        },
      },
      runtime: {},
